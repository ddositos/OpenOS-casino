...
local function render()
	...
	ws1:text(98, 17, "ЛКМ 3", 0x005500, 0xffffff)
	ws1:text(98, 18, "ПКМ 10", 0x005500, 0xffffff)
	--белая рамка
	...
	for j=0,35 do
		...
		ws1:bind(x,y,5,3,color, function(_,_,nickname, button)
			return bet(nickname, i, button == mouse.left and 3 or 10)
		end)
